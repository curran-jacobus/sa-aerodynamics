...
#Chosen
m = 1.8 #mass of aircraft  NOT INLCUDING WINGS AND HORIZONTAL STABILIZER (1.5 kg goal)
cm_cp = 0.025 #Distance from Cm to Cp (m)
...
hstab_aoa = 0 #Horizontal stabilizer AOA (in degrees)
